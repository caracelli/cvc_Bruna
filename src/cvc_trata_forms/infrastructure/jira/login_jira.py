...
from cvc_trata_forms.infrastructure.config.config_app import URL_JIRA as JIRA_CREATE_URL
    ...
    while time.time() < fim:
        ...
        if senha_ms_enviada:
            ...
            if aprovar is not None and (time.time() - ultimo_aprovar) > 25:
                from cvc_trata_forms.infrastructure.sistema.winutil import trazer_edge_frente
                trazer_edge_frente()
