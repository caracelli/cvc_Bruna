...
# Fica em %LOCALAPPDATA%\cvc_trata_forms\edge_profile (gravavel, por usuario).
_BASE = os.environ.get("LOCALAPPDATA") or os.path.expanduser("~")
PERFIL = os.path.join(_BASE, "cvc_trata_forms", "edge_profile")

# Marcador unico para identificar (e so afetar) os processos DESTE perfil.
MARCADOR_PERFIL = "cvc_trata_forms"
